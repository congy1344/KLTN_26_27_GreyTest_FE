    ...
    <AppShell maxWidth="wide">
            ...
            <div className="flex min-w-0 items-start gap-4">
              ...
              <div className="min-w-0">
                <h1 className="truncate text-2xl font-bold tracking-tight text-heading md:text-3xl">
                  Test Case · {project.name}
                </h1>
                <p className="mt-2 text-sm leading-relaxed text-body-subtle">
                  Chuẩn bị dữ liệu test từ các Test Plan đã approve.
                </p>
              </div>
            </div>
      ...
      <div className="mt-6 rounded-base border border-border-brand-subtle bg-brand-softer p-4 shadow-sm animate-fade-in">
        <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
          <div>
            <p className="text-sm font-semibold text-heading">Bước tiếp theo: Unit Test</p>
            <p className="mt-1 text-xs leading-relaxed text-body-subtle">
              Sau khi duyệt Test Case, chuyển sang màn Unit Test để chuẩn bị source test.
            </p>
          </div>
          {unitTestsEnabled ? (
            <Link to={`/projects/${projectId}/unit-tests`} className="btn btn-brand shrink-0">
              Mở Unit Test
